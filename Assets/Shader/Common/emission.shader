	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode174 = tex2D( _MainTex, uv_MainTex );
				
				float temp_output_86_0 = ( tex2DNode174.a * IN.ase_color.a * _Color0.a );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( tex2DNode174 * IN.ase_color * _Color0 ).rgb;
				float Alpha = saturate( temp_output_86_0 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = saturate( temp_output_86_0 );
...
/*ASEBEGIN
Version=18935
258;174;1325;961;779.2789;1033.552;1;True;False
Node;AmplifyShaderEditor.VertexColorNode;85;-94.7495,209.7618;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;174;-271.2377,-268.4908;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;175;-130.5745,-639.4133;Inherit;False;Property;_Color0;Color 0;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;86;419.3971,168.5607;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;84;414.8216,-107.7754;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;86;0;174;4
WireConnection;86;1;85;4
WireConnection;86;2;175;4
WireConnection;84;0;174;0
WireConnection;84;1;85;0
WireConnection;84;2;175;0
WireConnection;170;0;86;0
WireConnection;173;0;86;0
WireConnection;44;2;84;0
WireConnection;44;3;170;0
ASEEND*/
//CHKSM=BED0EBCAD60065C807DAFD0DB5563B38D0AA9400